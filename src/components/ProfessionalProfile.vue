<template>
  <div>
    <div>
      <h2 class="display-title font-weight-regular">Professional Profile</h2>
    </div>
    <div class="mx-4 d-flex-row">
      <div
        v-for="(item, i) in professionalProfile"
        :key="i"
        class="d-flex my-2"
      >
...
export default {
  computed: {
    ...mapGetters({
      professionalProfile: 'content/getProfessionalProfile'
    })
  }
}
</script>
